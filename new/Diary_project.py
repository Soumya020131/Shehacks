...
def register():
    ...
    password_entry.pack()
    Label(register_screen, text="").pack()
    register_screen.iconbitmap('d.ico')
    Button(register_screen, text="Register", width=10, height=1,bg="#BCADE0", activebackground="#D4C9AE",  command=register_user).pack()
    
# Designing window for login
def login():
    global login_screen
    login_screen = Toplevel(main_screen)
    login_screen.iconbitmap('d.ico')
    ...
    Label(login_screen, text="").pack()
    Button(login_screen, text="Login", width=10, height=1, bg="#BCADE0", activebackground="#D4C9AE",  command=login_verify).pack()
...
def login_success():
    ...
    login_success_screen.iconbitmap('d.ico')
    login_success_screen.title("Success")
    login_success_screen.geometry("150x100")
    Label(login_success_screen, text="Login Success").pack()
    Button(login_success_screen, text="OK", bg="#BCADE0", activebackground="#D4C9AE",  command=delete_login_success).pack()

# Designing popup for login invalid password
def password_not_recognised():
    global password_not_recog_screen
    password_not_recog_screen = Toplevel(login_screen)
    password_not_recog_screen.iconbitmap('d.ico')
    password_not_recog_screen.title("Success")
    password_not_recog_screen.geometry("150x100")
    Label(password_not_recog_screen, text="Invalid Password ").pack()
    Button(password_not_recog_screen, text="OK",bg="#BCADE0", activebackground="#D4C9AE", command=delete_password_not_recognised).pack()

# Designing popup for user not found
def user_not_found():
    global user_not_found_screen
    user_not_found_screen = Toplevel(login_screen)
    user_not_found_screen.iconbitmap('d.ico')
    user_not_found_screen.title("Success")
    user_not_found_screen.geometry("150x100")
    Label(user_not_found_screen, text="User Not Found").pack()
    Button(user_not_found_screen, text="OK", bg="#BCADE0", activebackground="#D4C9AE", command=delete_user_not_found_screen).pack()
...
def main_account_screen():
    global main_screen
    main_screen = Tk()
    main_screen.iconbitmap('d.ico')
    main_screen.geometry("400x250")
    main_screen.title("Account Login")
    Label(text="Welcome to Empurple", bg="lavender", width="300",height="2", font=("Verdana", 15)).pack()
    Label(text="Your personal Diary", bg="lavender", width="300",height="2", font=("Microsoft Sans Serif", 12)).pack()
    Label(text="").pack()
    Button(text="Login", height="2", width="30", bg="#BCADE0", activebackground="#D4C9AE", command=login).pack()
    Label(text="").pack()
    Button(text="Register", height="2", width="30", bg="#BCADE0", activebackground="#D4C9AE", command=register).pack()
...
class journal(Frame):
    ...
    def __init__(self, master=None):
        ...
        write_button = Button(self, text="Write", width=100,
                              height=10, bg="#BCADE0", activebackground="#D4C9AE", command=self.write)
        write_button.pack()
        # Read button binded to read function.
        read_button = Button(self, text="Read", width=100,
                             height=10, bg="#9C8FBA", activebackground="#D4C9AE", command=self.read)
        read_button.pack()
        # Edit button binded to edit function.
        edit_button = Button(self, text="Edit", width=100,
                             height=10, bg="#BCADE0", activebackground="#D4C9AE", command=self.edit)
        edit_button.pack()
        # Chatbot button.
        chatbot_button = Button(self, text="Chat with your friend Phoenix!!", width=100,
                             height=10,bg="#9C8FBA", activebackground="#D4C9AE", command=self.chatbot)
        chatbot_button.pack()
    ...
    def chatbot(self):
        '''this function calls the function defined in the "gui" module.This module is an user defined module.
        This module enables the user to chat with the chatbot Phoenix.'''
        import gui
        a = Tk()
        B = gui.ChatInterface(a)
        exit(0)
