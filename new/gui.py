...
# Menu bar
    ...
    # Options
        ...
        help_option.add_command(label="About Phoenix", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("Phonix v1.0",'Phonix is a chatbot who is your friend and you could chat with him whenever you feel like talking to a friend')

    def about(self):
        tkinter.messagebox.showinfo("Phoenix Developers","1.Soumya Srivastava\n2.Harleen Kaur")
    ...
    def color_theme_default(self):
        self.master.config(bg="#BCADE0")
        self.text_frame.config(bg="#BCADE0")
        self.entry_frame.config(bg="#BCADE0")
        self.text_box.config(bg="#9C8FBA", fg="#D4C9AE")
        self.entry_field.config(bg="#9C8FBA", fg="#D4C9AE", insertbackground="#D4C9AE")
        self.send_button_frame.config(bg="#BCADE0")
        self.send_button.config(bg="#9C8FBA", fg="#D4C9AE", activebackground="#9C8FBA", activeforeground="#D4C9AE")
        self.sent_label.config(bg="#BCADE0", fg="#D4C9AE")
